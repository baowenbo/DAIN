...
Run the training script:
    ...
    $ CUDA_VISIBLE_DEVICES=0 python train.py --datasetPath /tmp4/wenbobao_data/vimeo_triplet --batch_size 1 --save_which 1 --lr 0.0001 --rectify_lr 0.0001 --flow_lr_coe 0.01 --occ_lr_coe 0.0 --filter_lr_coe 1.0 --ctx_lr_coe 1.0 --alpha 0.0 1.0 --patience 4 --factor 0.2
